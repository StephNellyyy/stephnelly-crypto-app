...
<div className="w-full border-t bg-gray-50 pb-10">
  <div className="max-w-screen-2xl mx-auto px-6 lg:px-12 py-6 flex flex-col md:flex-row justify-between items-start md:items-center text-gray-500 text-sm">
    
    {/* LEFT SIDE */}
    <div className="flex flex-col gap-2 text-lg font-normal">
      <span className="font-bold text-gray-800">
        &copy; 2026 Crypto App | Student Project
      </span>

      <p className="text-xs text-red-500 max-w-md">
        This is a demo project and is not affiliated with Coinbase. Do not enter real personal information.
      </p>
